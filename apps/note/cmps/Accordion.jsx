...
export function Accordion() {
    ...
    function onCloseAccordion() {
        ...
        const fullNote = noteService.getEmptyNote(title, txt)
        noteService.save(fullNote)
            .then(setIsOpen(isOpen => !isOpen))
            .then(cleanInputs())
    }
            ...
            <div className="box-shadow">
                ...
                <section className="content">
                    ...
                    <div className="accordion-btns">
                        <button onClick={onCloseAccordion}>Close</button>
